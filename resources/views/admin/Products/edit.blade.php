...
<div class="container">
    ...
    <div class="row">
        ...
        <div id="form-content" class="col-md-8">
            <form id="survey-form" action="{{route('products.update', $data)}}" method="POST"
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group col-sm-9">
                        ...
                        <select name="producer" id="producer_id" class="form-control" value='{{$data->producer}}'>
