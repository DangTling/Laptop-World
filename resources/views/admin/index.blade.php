...
<head>
    ...
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('image/apple-icon.webp')}}">
    ...
    <meta name="twitter:image"
        content="https://s3.amazonaws.com/creativetim_bucket/products/50/original/material-dashboard.jpg">
    ...
    <link href="{{asset('css/demos.creative-tim.com_material-dashboard_assets_css_nucleo-icons.css')}}"
        rel="stylesheet" />
    <link href="{{asset('css/demos.creative-tim.com_material-dashboard_assets_css_nucleo-svg.css')}}"
        rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <script src="{{asset('js/material-dashboard2.min.js')}}"></script>
    <script defer
        src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317"
        integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA=="
        data-cf-beacon='{"rayId":"81b109eb390204e7","version":"2023.10.0","token":"1b7cbb72744b40c580f8633c6b62637e"}'
